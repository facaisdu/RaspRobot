...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_hub_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_hub_client/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_multimaster/rocon_hub_client" \
    install \
    $DESTDIR_ARG \
