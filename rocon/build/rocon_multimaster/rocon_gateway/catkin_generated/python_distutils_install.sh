...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_gateway"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_gateway/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_multimaster/rocon_gateway" \
    install \
    $DESTDIR_ARG \
