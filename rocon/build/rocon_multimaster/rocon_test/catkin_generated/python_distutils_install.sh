...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_test"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_test/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_multimaster/rocon_test" \
    install \
    $DESTDIR_ARG \
