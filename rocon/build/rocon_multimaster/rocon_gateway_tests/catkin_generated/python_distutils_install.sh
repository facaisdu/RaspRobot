...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_gateway_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_multimaster/rocon_gateway_tests/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_multimaster/rocon_gateway_tests" \
    install \
    $DESTDIR_ARG \
