...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_qt_gui/rocon_gateway_graph"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_qt_gui/rocon_gateway_graph/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_qt_gui/rocon_gateway_graph" \
    install \
    $DESTDIR_ARG \
