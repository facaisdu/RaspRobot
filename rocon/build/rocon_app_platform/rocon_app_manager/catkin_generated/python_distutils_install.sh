...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_app_platform/rocon_app_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_app_platform/rocon_app_manager/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_app_platform/rocon_app_manager" \
    install \
    $DESTDIR_ARG \
