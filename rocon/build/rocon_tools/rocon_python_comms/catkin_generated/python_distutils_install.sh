...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_python_comms"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_python_comms/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_tools/rocon_python_comms" \
    install \
    $DESTDIR_ARG \
