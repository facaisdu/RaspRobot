...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_console"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_console/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_tools/rocon_console" \
    install \
    $DESTDIR_ARG \
