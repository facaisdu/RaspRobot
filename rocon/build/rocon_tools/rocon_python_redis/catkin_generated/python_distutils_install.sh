...
echo_and_run cd "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_python_redis"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/sclab_robot/turtlebot_ws/rocon/src/rocon_tools/rocon_python_redis/setup.py" \
    build --build-base "/home/sclab_robot/turtlebot_ws/rocon/build/rocon_tools/rocon_python_redis" \
    install \
    $DESTDIR_ARG \
