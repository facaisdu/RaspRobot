...
class GetInteractionResponse(genpy.Message):
  _md5sum = "791b2d4e984d3bc84277d856a387a4ac"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_i().pack(self.interaction.hash))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.interaction.hash,) = _get_struct_i().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetInteraction(object):
  ...
  _md5sum = '85932dee808a9250b0623f6b04e00400'
