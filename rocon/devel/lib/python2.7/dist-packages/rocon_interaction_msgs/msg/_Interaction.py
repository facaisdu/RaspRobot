...
class Interaction(genpy.Message):
  _md5sum = "a118201d77d4921a4dbca2d7a413a812"
...
"""
  ...
  __slots__ = ['name','command','compatibility','group','description','icon','namespace','remappings','parameters','max','bringup_pairing','teardown_pairing','required_pairings','hash']
  _slot_types = ['string','string','string','string','string','rocon_std_msgs/Icon','string','rocon_std_msgs/Remapping[]','string','int32','bool','bool','string[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,command,compatibility,group,description,icon,namespace,remappings,parameters,max,bringup_pairing,teardown_pairing,required_pairings,hash
